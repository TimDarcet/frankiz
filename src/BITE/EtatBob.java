...
public class EtatBob{
    ...
    private static String TITRE_OUVERT = "BITE : Le bôb est ouvert :-)";
    private static String TITRE_FERME = "BITE : Le bôb est fermé :-(";
    private static String TITRE_INCONTACTABLE = "BITE : Le serveur est incontactable :-\\";
