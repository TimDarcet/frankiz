...
<form enctype='multipart/form-data' method='post' action='profile/account' class='profile account'>
    <fieldset>
        <div class="title">
        ...
        <input type='submit' class="button" name='new_passwd' value='Enregistrer'>
    </fieldset>
    ...
    <fieldset>
        ...
        <input type='submit' class="button" name='change_profile' value='Changer'>
    </fieldset>
</form>
