...
<xsl:template match="/">
  ...
  <xsl:apply-templates select="frankiz/page/module[@id='liens_navigation']"/>
      <div class="fkz_page">
      <div class="fkz_gauche">
        <xsl:apply-templates select="frankiz/page/module[@id='tours_kawa']"/>
        <xsl:apply-templates select="frankiz/page/module[@id='activites']"/>
        <xsl:apply-templates select="frankiz/page/module[@id='liens_contacts']"/>
	<xsl:apply-templates select="frankiz/page/module[@id='stats']"/>
      </div>
      <div class="fkz_centre">
        <xsl:apply-templates select="frankiz/page/module[@id='anniversaires']"/>
        <br/>
        <xsl:apply-templates select="frankiz/page/contenu/liste[@id='annonces']" mode="sommaire"/>
        <xsl:apply-templates select="frankiz/page/contenu/liste[@id='annonces']" mode="complet"/>
	<xsl:apply-templates select="frankiz/page/contenu/module[@id='trombino']"/>
        <xsl:apply-templates select="frankiz/page/contenu/formulaire"/>
      </div>
      <div class="fkz_droite">
      <xsl:apply-templates select="frankiz/page/module[@id='qdj']"/>
      </div>
      </div>
  </body>
  </html>
