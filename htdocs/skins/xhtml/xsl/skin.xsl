	...
	<div class="fkz_annonces">
		...
		<div class="fkz_annonces_titre">
			<b>
				...
				<xsl:text> </xsl:text>
				<span class="fkz_annonces_titre">Post-it : <xsl:value-of select="@titre"/></span>
			</b>
		</div>
