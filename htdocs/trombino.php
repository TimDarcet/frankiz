...
if(isset($_REQUEST['chercher'])) {
	...
	// GÈnÈration de la page si il y a au moins un critËre, sinon on raffiche le formulaire.
	if(!empty($where)) {
		...
		while(list($eleve_id,$nom,$prenom,$surnom,$piece_id,$section,$section_id,$cie,$promo,$login,$mail,$tel) = $DB_trombino->next_row()) {
			...
			if(verifie_permission('admin')) {
				...
				echo "<a href='".BASE_URL."/?su=$eleve_id'>Prendre l&apos;identitÈ de $prenom $nom</a>\n" ;
			}
		}		
